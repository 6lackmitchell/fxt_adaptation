...
def cbfdot_velx_uncontrolled(x):
    return 0.0

def cbfdot_vely_uncontrolled(x):
    return 0.0

def cbfdot_velz_uncontrolled(x):
    return G

def cbfdot_velx_controlled(x):
    return -Rot(x)[0,2]

def cbfdot_vely_controlled(x):
    return -Rot(x)[1,2]

def cbfdot_velz_controlled(x):
    return -Rot(x)[2,2]
